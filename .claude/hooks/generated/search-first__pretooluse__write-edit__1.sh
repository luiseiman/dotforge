...
RECOVERY_HINT='Use Grep or Glob to search for existing patterns before writing new code.'
...
# Action: check_flag
if forge_flag_consume "$SESSION_ID" 'search_context_ready'; then
    # Flag was present.
    exit 0
else
    # Flag absent.
